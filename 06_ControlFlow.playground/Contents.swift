...
var string: String = "i and you like watermelon"
for i in string {
    switch i {
    case "a":
    ...
    case "i":
        string = string.replacingOccurrences(of: String("i"), with: "I")
    case "o":
        string = string.replacingOccurrences(of: String("o"), with: "O")
    case "u":
        string = string.replacingOccurrences(of: String("u"), with: "U")
    case "y":
        string = string.replacingOccurrences(of: String("y"), with: "Y")
    default:
        break
    }
}
...
let devinGrade: [String : Double] = ["History": 4.4, "English": 4.6, "Geography": 5.0, "Science": 4.5, "Maths": 4.5]
let kevinGrade: [String : Double] = ["History": 4.3, "English": 4.9, "Geography": 4.6, "Science": 4.3, "Maths": 4.4]
