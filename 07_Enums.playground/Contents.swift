...
enum PizzaSize {
    case small(ingredient: Ingredient)
    case medium(firstIngredient: Ingredient, secondIngredient: Ingredient)
    case big(firstIngredient: Ingredient, secondIngredient: Ingredient, thirdIngredient: Ingredient)
}
...
let orderWithOneIngredient  = PizzaSize.small(ingredient: Ingredient.Cheese)
let orderWithTwoIngredient: PizzaSize = .medium(firstIngredient: Ingredient.Beef, secondIngredient: Ingredient.Ham)
let orderWithThreeIngredient: PizzaSize = .big(firstIngredient: Ingredient.Onion, secondIngredient: Ingredient.Pepper, thirdIngredient: Ingredient.Spinach)
