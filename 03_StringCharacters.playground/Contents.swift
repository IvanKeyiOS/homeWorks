 ...
 */
print("=====================================================================================================================")
let words = totalString.components(separatedBy: CharacterSet.whitespacesAndNewlines.union(.punctuationCharacters))
...
print("Слова в тектсе: \(filteredWords)")

print("=====================================================================================================================")

let sentences = totalString.components(separatedBy: CharacterSet(charactersIn: ".!?"))  // Разбиваем по . ! ?
let filteredSentences = sentences.filter { !$0.trimmingCharacters(in: .whitespaces).isEmpty }  // Убираем пустые элементы
...
let vowelLetter = "a,e,i,o,u,w,y,A,E,I,O,U,W,Y"
...
print(updatedText)  // "*то пр*мер т*кст* с гл*сн*ми б*кв*ми."
